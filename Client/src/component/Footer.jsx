    ...
    <footer className="bg-white text-black py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 px-8">
        ...
        <div>
          ...
          <Link to="/" className="block hover:text-blue-600 mb-2">AI Mock Interview</Link>
          <Link to="/=" className="block hover:text-blue-600 mb-2">Interview Prepration</Link>
          <Link to="/" className="block hover:text-blue-600 mb-2">English Communication</Link>
        </div>

        {/* Resources Section */}
        <div>
          <h2 className="text-2xl font-semibold mb-6 text-black">Resources</h2>
          <Link to="/" className="block hover:text-blue-600 mb-2">Resume Formatting Tips</Link>
          <Link to="/" className="block hover:text-blue-600 mb-2">Notes</Link>
          <Link to="/" className="block hover:text-blue-600 mb-2">Interview Tips</Link>
          <Link to="/" className="block hover:text-blue-600 mb-4">DSA</Link>
